...
class SimpleEquation(Chromosome):
    ...
    @classmethod
    def random_instance(cls, l=(lambda a, b: 6 * a - a * a + 4 * b - b * b)):
        return SimpleEquation(randrange(100), randrange(100), l=l)
...
if __name__ == "__main__":
    inital_population = [SimpleEquation.random_instance() for _ in range(20)]
